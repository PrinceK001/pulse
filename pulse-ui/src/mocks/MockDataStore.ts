        ...
        whitelist: [
          {
            ...
            scope: ['logs', 'traces'],
            sdks: ['pulse_android_native', 'pulse_ios_native'],
          },
        ],
        blacklist: [
          {
            ...
            sdks: ['pulse_android_native', 'pulse_android_rn', 'pulse_ios_native', 'pulse_ios_rn'],
          },
          {
            id: generateId(),
            name: 'debug_log',
        ...
        rules: [
          ...
          },
          {
            ...
            match: {
              ...
              sdks: ['pulse_android_native', 'pulse_android_rn'],
        ...
        rules: [
          {
            id: generateId(),
            name: 'app_version',
            sdks: ['pulse_android_java', 'pulse_ios_native'],
            value: '^2\\..*',
...
type SdkEnumV1 = 'pulse_android_java' | 'pulse_android_rn' | 'pulse_ios_native' | 'pulse_ios_rn';
