...
/**
 * Builder class for {@link io.opentelemetry.sdk.trace.export.BatchSpanProcessor}.
 *
 * @since 1.27.0
 */
public final class SBB {
    private static final Logger logger = Logger.getLogger(SBB.class.getName());

    // Visible for testing
    static final long DEFAULT_SCHEDULE_DELAY_MILLIS = 1000;
    // Visible for testing
    static final int DEFAULT_MAX_QUEUE_SIZE = 5;
    // Visible for testing
    static final int DEFAULT_MAX_EXPORT_BATCH_SIZE = 1;
    // Visible for testing
     ...
     */
    public SBB setScheduleDelay(long delay, TimeUnit unit) {
     ...
     * DEFAULT_SCHEDULE_DELAY_MILLIS}ms.
     */
    public SBB setScheduleDelay(Duration delay) {
     ...
     */
    public SBB setExporterTimeout(long timeout, TimeUnit unit) {
        requireNonNull(unit, "unit");
     ...
     * defaults to {@value DEFAULT_EXPORT_TIMEOUT_MILLIS}ms.
     */
    public SBB setExporterTimeout(Duration timeout) {
     ...
     * @see SBB#DEFAULT_MAX_QUEUE_SIZE
     */
    public SBB setMaxQueueSize(int maxQueueSize) {
     ...
     * @return this.
     * @see SBB#DEFAULT_MAX_EXPORT_BATCH_SIZE
     */
    public SBB setMaxExportBatchSize(int maxExportBatchSize) {
     ...
     */
    public SBB setMeterProvider(MeterProvider meterProvider) {
    ...
    /**
     * Returns a new {@link BatchSpanProcessor} that batches, then forwards them to the given
     * {@code spanExporter}.
     *
