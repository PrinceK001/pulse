...
/**
 * Builder class for {@link io.opentelemetry.sdk.logs.export.BatchLogRecordProcessor}.
 *
 * @since 1.27.0
 */
public final class NBB {
    private static final Logger logger = Logger.getLogger(NBB.class.getName());
    ...
    NBB(LogRecordExporter logRecordExporter) {
     ...
     */
    public NBB setScheduleDelay(long delay, TimeUnit unit) {
     ...
     * DEFAULT_SCHEDULE_DELAY_MILLIS}ms.
     */
    public NBB setScheduleDelay(Duration delay) {
     ...
     */
    public NBB setExporterTimeout(long timeout, TimeUnit unit) {
        requireNonNull(unit, "unit");
     ...
     * defaults to {@value DEFAULT_EXPORT_TIMEOUT_MILLIS}ms.
     */
    public NBB setExporterTimeout(Duration timeout) {
     ...
     * @see NBB#DEFAULT_MAX_QUEUE_SIZE
     */
    public NBB setMaxQueueSize(int maxQueueSize) {
     ...
     * @return this.
     * @see NBB#DEFAULT_MAX_EXPORT_BATCH_SIZE
     */
    public NBB setMaxExportBatchSize(int maxExportBatchSize) {
     ...
     */
    public NBB setMeterProvider(MeterProvider meterProvider) {
